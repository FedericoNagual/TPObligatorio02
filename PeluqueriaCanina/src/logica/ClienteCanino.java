 ...
 */
@Entity
public class ClienteCanino implements Serializable {
    //datos de un cliente canino, los cuales engloba todos los datos requeridos por la aplicacion.
    @Id
    ...
    public ClienteCanino() {
    }

    public ClienteCanino(String num_cliente, String nombre_perro, String raza, String color, boolean alergico, boolean atencion_especial, String nombre_duenio, String celular_duenio, String observaciones) {
